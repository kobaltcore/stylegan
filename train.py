...
if 1:
    ...
    # Number of GPUs.
    desc += '-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 8; # sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}
    ...
    # Default options.
    EPOCHS = 500
    IMGS_IN_DATASET = 3.409
    train.total_kimg = 7000 + (IMGS_IN_DATASET * EPOCHS)
    sched.lod_initial_resolution = 8
    sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003}
    # sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.0015, 1024: 0.003}
